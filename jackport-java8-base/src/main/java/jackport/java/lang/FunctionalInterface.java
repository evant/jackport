 ...
 * <p>
 * Conceptually, a functional interface has exactly one abstract method.  Since {@linkplain
 ...
 * message unless:
 * <p>
 * <ul> <li> The type is an interface type and not an annotation type, enum, or class. <li> The
 * annotated type satisfies the requirements of a functional interface. </ul>
 * <p>
