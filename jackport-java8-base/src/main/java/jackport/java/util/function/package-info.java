 ...
 * {@link jackport.java.lang.FunctionalInterface}. This annotation is not a requirement
 ...
 * {@link jackport.java.util.function.Function} (unary function from {@code T} to {@code R}),
 * {@link jackport.java.util.function.Consumer} (unary function from {@code T} to {@code void}),
 * {@link jackport.java.util.function.Predicate} (unary function from {@code T} to {@code
 * boolean}),
 * and {@link jackport.java.util.function.Supplier} (nilary function to {@code R}).
 * </li>
 *
 ...
 * {@link jackport.java.util.function.BiFunction} (binary function from {@code T} and
 * {@code U} to {@code R}).
 * </li>
 *
 * <li>There are additional derived function shapes which extend the basic
 * function shapes, including {@link jackport.java.util.function.UnaryOperator}
 * (extends {@code Function}) and {@link jackport.java.util.function.BinaryOperator}
 ...
 * prefix {@code ToXxx}, as in {@link jackport.java.util.function.ToIntFunction}.
 * Otherwise, type arguments are specialized left-to-right, as in
 * {@link jackport.java.util.function.DoubleConsumer}
 * or {@link jackport.java.util.function.ObjIntConsumer}.
 ...
 * as in {@link jackport.java.util.function.ObjIntConsumer}.)
 ...
 * prefix may be left out (as in {@link jackport.java.util.function.ObjIntConsumer}).
 * </li>
 * </ul>
 *
 * @see jackport.java.lang.FunctionalInterface
 * @since 1.8
 */
