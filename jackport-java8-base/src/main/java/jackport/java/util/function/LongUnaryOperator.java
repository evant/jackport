    ...
    default LongUnaryOperator compose(LongUnaryOperator before) {
        ...
        return new LongUnaryOperator() {
            ...
            public long applyAsLong(long v) {
                return LongUnaryOperator.this.applyAsLong(before.applyAsLong(v));
            }
        };
    }
    ...
    default LongUnaryOperator andThen(LongUnaryOperator after) {
        ...
        return new LongUnaryOperator() {
            ...
            public long applyAsLong(long t) {
                return after.applyAsLong(LongUnaryOperator.this.applyAsLong(t));
            }
        };
    }

    LongUnaryOperator IDENTITY = new LongUnaryOperator() {
        @Override
