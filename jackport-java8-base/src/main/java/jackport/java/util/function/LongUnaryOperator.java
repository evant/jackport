...
public interface LongUnaryOperator {
    ...
    abstract class $ implements LongUnaryOperator {

        private static final LongUnaryOperator IDENTITY = new $() {
            @Override
         ...
         * @see #andThen(LongUnaryOperator)
         */
        public static LongUnaryOperator compose(final LongUnaryOperator $this, final LongUnaryOperator before) {
         ...
         * @see #compose(LongUnaryOperator)
         */
        public static LongUnaryOperator andThen(final LongUnaryOperator $this, final LongUnaryOperator after) {
