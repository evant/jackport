...
import jackport.java.util.function.Consumer;
import jackport.java.util.function.DoubleConsumer;
import jackport.java.util.function.IntConsumer;
import jackport.java.util.function.LongConsumer;
...
public final class Spliterators {
     ...
     *                                  of this spliterator's source or elements beyond {@code
     *                                  SIZED} and
     ...
     *                                        the end index, if the start index is negative, or the
     *                                        end index is
    ...
    static final class ArraySpliterator<T> implements Spliterator<T> {
        ...
        public Spliterator<T> trySplit() {
            ...
            return (lo >= mid)
                    ? null
                    : new ArraySpliterator<T>(array, lo, index = mid, characteristics);
        }
    ...
    public static abstract class AbstractSpliterator<T> implements Spliterator<T> {
         ...
         *                                  source or elements.  If {@code SIZED} is reported then
         *                                  this
