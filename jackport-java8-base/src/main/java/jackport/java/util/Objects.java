 ...
 * questions.
 */
package jackport.java.util;

import java.util.Arrays;
import java.util.Comparator;

import jackport.java.util.function.Supplier;
...
public final class Objects {
     ...
     * {@link Arrays#deepEquals(Object[], Object[]) Arrays.deepEquals} is used to determine
     * equality. Otherwise, equality is determined by using the {@link Object#equals equals} method
     ...
     * the input values were placed into an array, and that array were hashed by calling {@link
     ...
     * may not be thrown depending on what ordering policy, if any, the {@link Comparator
    ...
    /**
     * Returns {@code true} if the provided reference is {@code null} otherwise returns {@code
     * false}.
     *
     * @param obj a reference to be checked against {@code null}
     * @return {@code true} if the provided reference is {@code null} otherwise {@code false}
     * @apiNote This method exists to be used as a {@link jackport.java.util.function.Predicate},
     * {@code filter(Objects::isNull)}
     * @see jackport.java.util.function.Predicate
     * @since 1.8
     */
